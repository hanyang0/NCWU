var btnbar = {
  ...
  init: function (arrdata) {
    if (!document.getElementById("btnbar")) {
      $("body").prepend(
        '<div  class="btnbar"> <div class="btnbar_panel"> <div class="btnbar_left"></div> <div class="btnbar_items_panel"><div class="btnbar_items_panel_scroll" style="left: 30%;">  </div></div><div class="btnbar_right"></div>   </div></div>'
      );
    }
